...
export const tables = {
  'zh-CN': {
    ...
    subAgentsTokens: '{period} · 按 Tokens 排序 · 模型按费用',
    statActive: '活跃天数',
    ...
    rowAgents: '经 {agents}',
    rowAgent: '来自 {agent}',
    rowRates: '{source} 单价 / 百万：输入 {input} · 缓存读 {read} · 缓存写 {write} · 输出 {output}',
    others: '其他 {n} 项模型用量',
  ...
  en: {
    ...
    subAgentsTokens: '{period} · ranked by tokens · models by cost',
    ...
    rowAgent: 'via {agent}',
    rowRates: '{source} USD / million: input {input} · cache read {read} · cache write {write} · output {output}',
