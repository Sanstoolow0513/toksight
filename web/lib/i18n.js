...
export const tables = {
  'zh-CN': {
    ...
    emptyBody: '先用 AI agent 跑几个会话再刷新本页。终端运行 `toksight env` 可以查看各 agent 的扫描位置。',
    warnings: '{n} 条采集警告',
  ...
  en: {
    ...
    loading: 'Reading local sessions…',
    ...
    emptyBody: 'Run a few sessions with your AI agents, then refresh. `toksight env` in a terminal shows where each agent is scanned.',
